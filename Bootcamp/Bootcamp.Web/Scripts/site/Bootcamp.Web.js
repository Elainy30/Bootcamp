...
(function (Bootcamp) {
    ...
    })(Administration = Bootcamp.Administration || (Bootcamp.Administration = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Administration;
...
(function (Bootcamp) {
    ...
    })(BasicSamples = Bootcamp.BasicSamples || (Bootcamp.BasicSamples = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Bootcamp.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Bootcamp.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Bootcamp.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Bootcamp) {
    ...
    })(Common = Bootcamp.Common || (Bootcamp.Common = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Common;
...
(function (Bootcamp) {
    ...
    })(Membership = Bootcamp.Membership || (Bootcamp.Membership = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Membership;
...
(function (Bootcamp) {
    ...
    })(Northwind = Bootcamp.Northwind || (Bootcamp.Northwind = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Northwind;
...
(function (Bootcamp) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Bootcamp.Northwind.Gender', 'Bootcamp.Northwind.Entities.Gender');
    })(Northwind = Bootcamp.Northwind || (Bootcamp.Northwind = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
...
(function (Bootcamp) {
    ...
    })(Authorization = Bootcamp.Authorization || (Bootcamp.Authorization = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Administration;
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.ProductDialog));
    ...
    (function (Northwind) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Bootcamp.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Bootcamp.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Bootcamp.Common.ReportHelper.execute({
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Bootcamp.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Bootcamp.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Bootcamp.Northwind.OrderDialog();
                        ...
                        var chai = Bootcamp.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Bootcamp.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Bootcamp.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.OrderDialog));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Bootcamp.Northwind.CategoryService.Retrieve({
        ...
        }(Bootcamp.Northwind.CategoryDialog));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Bootcamp.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Bootcamp.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Bootcamp.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Bootcamp.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Bootcamp.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Bootcamp.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Bootcamp.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Bootcamp.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Bootcamp.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Bootcamp.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Bootcamp.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return Bootcamp.LanguageList.getValue();
            };
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.SupplierDialog));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Bootcamp.Northwind.SupplierGrid));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Bootcamp.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Bootcamp.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Bootcamp.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Bootcamp.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Bootcamp.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Bootcamp.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Bootcamp.Northwind.CustomerDialog));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.CustomerGrid));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = Bootcamp.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(Bootcamp.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Bootcamp.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Bootcamp.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Bootcamp.Northwind.OrderDetailDialog));
...
(function (Bootcamp) {
    ...
    (function (Northwind) {
        ...
        }(Bootcamp.Common.GridEditorBase));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Northwind.OrderDetailsEditor));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Bootcamp.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Bootcamp.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Bootcamp.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Bootcamp.Northwind.CategoryRow.lookupKey;
            };
            /**
    ...
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Bootcamp.BasicProgressDialog();
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        ...
        }(Bootcamp.Common.BulkServiceAction));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Bootcamp.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Bootcamp.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Bootcamp.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Bootcamp.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Bootcamp.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Bootcamp.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Bootcamp.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Bootcamp) {
    ...
    Bootcamp.SelectableEntityGrid = SelectableEntityGrid;
})(Bootcamp || (Bootcamp = {}));
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Bootcamp.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Bootcamp.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Bootcamp.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Bootcamp.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Bootcamp.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Bootcamp.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Bootcamp.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Bootcamp.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Bootcamp.Northwind.ProductService.baseUrl; };
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Bootcamp.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Bootcamp.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Bootcamp.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Bootcamp.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Bootcamp) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Bootcamp.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Bootcamp.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Bootcamp.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
(function (Bootcamp) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Bootcamp.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Bootcamp.LanguageList || (Bootcamp.LanguageList = {}));
})(Bootcamp || (Bootcamp = {}));
...
(function (Bootcamp) {
    ...
    (function (ScriptInitialization) {
        ...
        Q.Config.rootNamespaces.push('Bootcamp');
        Serenity.EntityDialog.defaultLanguageList = Bootcamp.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Bootcamp.ScriptInitialization || (Bootcamp.ScriptInitialization = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    ...
    Bootcamp.BasicProgressDialog = BasicProgressDialog;
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var DialogUtils;
    ...
    })(DialogUtils = Bootcamp.DialogUtils || (Bootcamp.DialogUtils = {}));
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Common;
...
(function (Bootcamp) {
    ...
    Bootcamp.StaticTextBlock = StaticTextBlock;
})(Bootcamp || (Bootcamp = {}));
var Bootcamp;
(function (Bootcamp) {
    var Common;
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Bootcamp.Authorization.userDefinition.DisplayName,
...
//# sourceMappingURL=Bootcamp.Web.js.map